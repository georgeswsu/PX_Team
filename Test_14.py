...
# Azure endpoint and API key from your Azure portal
endpoint = "https://sitemap-wsu-test-1.cognitiveservices.azure.com/"
api_key = "319cfd9282ed4335b1d7def4a75901e9"
...
# Function to process PDF using Azure Document Intelligence and retrieve the JSON data
def process_pdf_with_azure(pdf_filepath):
    with open(pdf_filepath, "rb") as f:
        poller = document_analysis_client.begin_analyze_document(
            model_id="Table_3",  # Custom model ID
            document=f
        )
    ...
    return {"analyzeResult": {"tables": tables_json}}
...
def upload_file():
    if request.method == 'POST':
        ...
        if file and file.filename.endswith('.pdf'):
            ...
            data_json = process_pdf_with_azure(filepath)

            # Proceed with the rest of the existing code
            ...
            client_data_frame = parse_client(data_json['analyzeResult']['tables'])
            ...
            location_data_frame = parse_location(data_json['analyzeResult']['tables'], client_index_map)
            ...
            task_data_frame = parse_tasks(data_json['analyzeResult']['tables'], location_index_map)
